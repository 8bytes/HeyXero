...
module.exports = (robot) ->
  ...
  robot.respond(/i need to (set up a company)?(register a business)?/i, (res) ->
    ...
    res.reply('It looks like you need some help - start with the www.businessnamechooser.com.au to get the right name or have a <a href="https://m.me/ShelfCompaniesAustralia/">chat on messenger here</a> to help set it up')    #these are blatant plugs for my business that you can remove!
  )
